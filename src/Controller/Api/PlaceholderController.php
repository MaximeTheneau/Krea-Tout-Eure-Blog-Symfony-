...
/**
 * @Route("/api/placeholder",name="api_placeholder_")
 */
class PlaceholderController extends ApiController
{
     ...
     */
    public function browse(ImagePlaceholderRepository $placeholderRepository ): JsonResponse
    {
    
        $allPosts = $placeholderRepository->findAll();
        #dd($allPages);
